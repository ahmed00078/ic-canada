...
@Component({
  selector: 'app-s6o4o7-dataTab',
  templateUrl: './s6o4o7-dataTab.component.html',
  styleUrls: ['./s6o4o7-dataTab.component.css']
})
export class S6o4o7DataTabComponent implements OnInit, OnChanges {
