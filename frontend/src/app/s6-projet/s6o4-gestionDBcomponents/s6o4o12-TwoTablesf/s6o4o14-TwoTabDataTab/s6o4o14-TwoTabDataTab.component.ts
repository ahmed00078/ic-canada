...
@Component({
  selector: 'app-s6o4o14-TwoTabDataTab',
  templateUrl: './s6o4o14-TwoTabDataTab.component.html',
  styleUrls: ['./s6o4o14-TwoTabDataTab.component.css'],
})
export class S6o4o14TwoTabDataTabComponent implements OnInit {
