...
@Component({
  selector: 'app-s6o4o15-TwoTabDataTabLie',
  templateUrl: './s6o4o15-TwoTabDataTabLie.component.html',
  styleUrls: ['./s6o4o15-TwoTabDataTabLie.component.css']
})
export class S6o4o15TwoTabDataTabLieComponent implements OnInit {
